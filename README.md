...
The [validator](https://confluence.hl7.org/display/FHIR/Using+the+FHIR+Validator) has  the possiblity to run the transforms, currently a patched version is necessary to run the steps below:
